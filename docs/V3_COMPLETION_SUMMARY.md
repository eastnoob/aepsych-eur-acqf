...
- HardExclusionAcqf类 (76 lines)
- CombinedAcqf类 (91 lines)  
- load_from_config函数支持V3
- 测试代码验证硬排除机制
...
V3_IMPROVEMENT_REPORT.md（600+ 行）
