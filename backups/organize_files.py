...
moves = [
    # Source code -> src/
    (['eur_anova_pair.py', 'eur_anova_multi.py', 'gower_distance.py', 'gp_variance.py', 'multiscale_learned_implementation.py'], 'src'),
    
    # Tests -> test/
    (['test_aepsych_integration.py', 'test_import.py', 'test_multi_order.py'], 'test'),
    
    # Docs -> docs/
    (['FINAL_SUMMARY.md', 'QUICK_REFERENCE.md', 'MULTISCALE_LEARNED_PERTURBATION.md', 
      'INTUITIVE_EXPLANATION.md', 'COMPLETION_REPORT_MULTISCALE_LEARNED.md', 
      'AEPSYCH_INTEGRATION.md', 'CODE_REVIEW_FIXES.md', 'EXPERIMENT_DESIGN.md', 
      'REFACTORING_SUMMARY.md', 'HANDOVER_HYBRID_PERTURBATION.md', 'CHANGELOG.md', 
      'CONTRIBUTORS.md', 'USAGE_MULTI_ORDER.md'], 'docs'),
    
    # Config -> configs/
    (['recommended_config.ini'], 'configs'),
    
    # Backups -> backups/
    (['eur_anova_pair.py.bak', 'eur_anova_multi.py.bak', 'gower_distance.py.bak'], 'backups'),
...
print("  docs/             - 文档")
print("  configs/          - 配置文件")
print("  examples/         - 示例和演示")
print("  backups/          - 备份文件")
print("  archive/          - 归档文件")
print("  modules/          - 其他模块")
print("  Introduction/     - 介绍文档")
print("  exp_design/       - 实验设计")
